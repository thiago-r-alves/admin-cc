...
const actionButtonClass =
  'inline-flex min-h-[38px] cursor-pointer items-center justify-center gap-[0.42rem] rounded-ui-md px-[0.85rem] py-[0.6rem] text-[0.78rem] font-black uppercase transition-[background,border-color,color,opacity] duration-[180ms] disabled:cursor-wait disabled:opacity-70 max-[760px]:flex-[1_1_120px]';
