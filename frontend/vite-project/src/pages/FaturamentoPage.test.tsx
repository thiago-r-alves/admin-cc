...
const summaryFixture: IBillingSummaryResponse = {
  ...
  paymentBreakdown: [
    { status: 'pendente', label: 'Pendente', revenue: 300, count: 1 },
    { status: 'nota_fiscal_pendente', label: 'NF pendente', revenue: 180, count: 1 },
    { status: 'paga', label: 'Pago', revenue: 200, count: 1 },
  ],
  topClients: [
    {
      clientId: 'cli-1',
